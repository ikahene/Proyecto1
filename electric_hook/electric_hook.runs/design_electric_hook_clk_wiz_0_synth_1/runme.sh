...
HD_PWD='C:/Users/byane/OneDrive/Escritorio/Proyecto1/electric_hook/electric_hook.runs/design_electric_hook_clk_wiz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_electric_hook_clk_wiz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_electric_hook_clk_wiz_0.tcl
