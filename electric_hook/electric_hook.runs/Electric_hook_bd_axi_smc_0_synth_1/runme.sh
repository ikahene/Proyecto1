...
HD_PWD='C:/Users/byane/OneDrive/Escritorio/Proyecto1/Electric_Hook/Electric_Hook.runs/Electric_hook_bd_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Electric_hook_bd_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Electric_hook_bd_axi_smc_0.tcl
