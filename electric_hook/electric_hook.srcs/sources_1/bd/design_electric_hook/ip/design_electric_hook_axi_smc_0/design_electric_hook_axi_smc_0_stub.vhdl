...
-- Date        : Fri Sep 19 19:27:06 2025
-- Host        : BenjaUni running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top design_electric_hook_axi_smc_0 -prefix
--               design_electric_hook_axi_smc_0_ design_electric_hook_axi_smc_0_stub.vhdl
-- Design      : design_electric_hook_axi_smc_0
...
entity design_electric_hook_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
...
end design_electric_hook_axi_smc_0;

architecture stub of design_electric_hook_axi_smc_0 is
...
attribute X_CORE_INFO of stub : architecture is "bd_a564,Vivado 2020.1";
begin
end;
