...
################################################################
# This is a generated script based on design: bd_becb
#
...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG000_BASE_ADDR {0x0000000076000000} \
   ...
   CONFIG.S_ARUSER_WIDTH {8} \
   CONFIG.S_AWUSER_WIDTH {8} \
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MAX_WUSER_BITS_PER_BYTE {0} \
   CONFIG.MEP_IDENTIFIER_WIDTH {1} \
   CONFIG.M_ARUSER_WIDTH {8} \
   CONFIG.M_AWUSER_WIDTH {8} \
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SC_ARUSER_WIDTH {8} \
   CONFIG.SC_AWUSER_WIDTH {8} \
