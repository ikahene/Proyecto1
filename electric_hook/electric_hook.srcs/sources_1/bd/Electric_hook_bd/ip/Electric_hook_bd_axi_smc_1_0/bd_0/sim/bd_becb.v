...
//--------------------------------------------------------------------------------
//Command: generate_target bd_becb.bd
//Design : bd_becb
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_becb,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_becb,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "Electric_hook_bd_axi_smc_1_0.hwdef" *) 
module bd_becb
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
    ...
    aclk,
    aresetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 M00_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME M00_AXI, ADDR_WIDTH 6, ARUSER_WIDTH 8, AWUSER_WIDTH 8, BUSER_WIDTH 0, CLK_DOMAIN /clk_wiz_clk_out1, DATA_WIDTH 32, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 7, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 7, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) output [5:0]M00_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 M00_AXI ARUSER" *) output [7:0]M00_AXI_aruser;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 M00_AXI AWUSER" *) output [7:0]M00_AXI_awuser;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S00_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S00_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 8, AWUSER_WIDTH 8, BUSER_WIDTH 0, CLK_DOMAIN /clk_wiz_clk_out1, DATA_WIDTH 32, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 1, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 7, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 7, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 1, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [31:0]S00_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_BUSIF M00_AXI:S00_AXI, ASSOCIATED_CLKEN s_sc_aclken, CLK_DOMAIN /clk_wiz_clk_out1, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input aclk;
  ...
  wire [7:0]m00_exit_pipeline_m_axi_ARUSER;
  ...
  wire [7:0]m00_exit_pipeline_m_axi_AWUSER;
  ...
  assign M00_AXI_aruser[7:0] = m00_exit_pipeline_m_axi_ARUSER;
  ...
  assign M00_AXI_awuser[7:0] = m00_exit_pipeline_m_axi_AWUSER;
  ...
  assign S00_AXI_1_ARUSER = S00_AXI_aruser[7:0];
  ...
  assign S00_AXI_1_AWUSER = S00_AXI_awuser[7:0];
  ...
  m00_exit_pipeline_imp_1QI30TU m00_exit_pipeline
       (.aclk(m_sc_clk_1),
  ...
  s00_entry_pipeline_imp_RB28Z5 s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_X8WXKB s00_nodes
...
module m00_exit_pipeline_imp_1QI30TU
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
  ...
  wire [7:0]m00_exit_M_AXI_ARUSER;
  ...
  wire [7:0]m00_exit_M_AXI_AWUSER;
  ...
  assign m_axi_aruser[7:0] = m00_exit_M_AXI_ARUSER;
  ...
  assign m_axi_awuser[7:0] = m00_exit_M_AXI_AWUSER;
...
module s00_entry_pipeline_imp_RB28Z5
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  assign s_axi_1_ARUSER = s_axi_aruser[7:0];
  assign s_axi_1_ARVALID = s_axi_arvalid;
  ...
  assign s_axi_1_AWUSER = s_axi_awuser[7:0];
  assign s_axi_1_AWVALID = s_axi_awvalid;
  assign s_axi_1_BREADY = s_axi_bready;
  assign s_axi_1_RREADY = s_axi_rready;
  assign s_axi_1_WDATA = s_axi_wdata[31:0];
  ...
  bd_becb_s00mmu_0 s00_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_becb_s00sic_0 s00_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_becb_s00tr_0 s00_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
