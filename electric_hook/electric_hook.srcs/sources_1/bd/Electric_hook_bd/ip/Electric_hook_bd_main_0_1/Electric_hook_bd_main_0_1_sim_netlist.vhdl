...
--               c:/Users/byane/OneDrive/Escritorio/Proyecto1/Electric_Hook/Electric_Hook.srcs/sources_1/bd/Electric_hook_bd/ip/Electric_hook_bd_main_0_1/Electric_hook_bd_main_0_1_sim_netlist.vhdl
...
entity Electric_hook_bd_main_0_1_clk_div is
  port (
    clk_div_catch_fish : out STD_LOGIC;
    clk : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Electric_hook_bd_main_0_1_clk_div : entity is "clk_div";
end Electric_hook_bd_main_0_1_clk_div;

architecture STRUCTURE of Electric_hook_bd_main_0_1_clk_div is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Electric_hook_bd_main_0_1_debouncer is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Electric_hook_bd_main_0_1_debouncer : entity is "debouncer";
end Electric_hook_bd_main_0_1_debouncer;

architecture STRUCTURE of Electric_hook_bd_main_0_1_debouncer is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Electric_hook_bd_main_0_1_debouncer_0 is
  port (
    btn_debounced : out STD_LOGIC_VECTOR ( 0 to 0 );
    clk : in STD_LOGIC;
    btn : in STD_LOGIC_VECTOR ( 0 to 0 )
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Electric_hook_bd_main_0_1_debouncer_0 : entity is "debouncer";
end Electric_hook_bd_main_0_1_debouncer_0;

architecture STRUCTURE of Electric_hook_bd_main_0_1_debouncer_0 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Electric_hook_bd_main_0_1_debouncer_1 is
  port (
    btn_debounced : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Electric_hook_bd_main_0_1_debouncer_1 : entity is "debouncer";
end Electric_hook_bd_main_0_1_debouncer_1;

architecture STRUCTURE of Electric_hook_bd_main_0_1_debouncer_1 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Electric_hook_bd_main_0_1_debouncer_2 is
  port (
    btn_debounced : out STD_LOGIC_VECTOR ( 0 to 0 );
    clk : in STD_LOGIC;
    btn : in STD_LOGIC_VECTOR ( 0 to 0 )
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Electric_hook_bd_main_0_1_debouncer_2 : entity is "debouncer";
end Electric_hook_bd_main_0_1_debouncer_2;

architecture STRUCTURE of Electric_hook_bd_main_0_1_debouncer_2 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Electric_hook_bd_main_0_1_rgb_controller is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Electric_hook_bd_main_0_1_rgb_controller : entity is "rgb_controller";
end Electric_hook_bd_main_0_1_rgb_controller;

architecture STRUCTURE of Electric_hook_bd_main_0_1_rgb_controller is
  signal clear : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Electric_hook_bd_main_0_1_main is
  port (
    clk_div_catch_fish : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Electric_hook_bd_main_0_1_main : entity is "main";
end Electric_hook_bd_main_0_1_main;

architecture STRUCTURE of Electric_hook_bd_main_0_1_main is
...
clk_divider: entity work.Electric_hook_bd_main_0_1_clk_div
     port map (
      clk => clk,
      clk_div_catch_fish => clk_div_catch_fish
    );
debounce0: entity work.Electric_hook_bd_main_0_1_debouncer
     port map (
      btn(0) => btn(0),
      btn_debounced(0) => btn_debounced(0),
      clk => clk
    );
debounce1: entity work.Electric_hook_bd_main_0_1_debouncer_0
     port map (
      btn(0) => btn(1),
      btn_debounced(0) => btn_debounced(1),
      clk => clk
    );
debounce2: entity work.Electric_hook_bd_main_0_1_debouncer_1
     port map (
...
debounce3: entity work.Electric_hook_bd_main_0_1_debouncer_2
     port map (
      btn(0) => btn(3),
...
rgb_control: entity work.Electric_hook_bd_main_0_1_rgb_controller
     port map (
      CO(0) => rgb2,
      clk => clk,
...
entity Electric_hook_bd_main_0_1 is
  ...
  attribute NotValidForBitStream of Electric_hook_bd_main_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Electric_hook_bd_main_0_1 : entity is "Electric_hook_bd_main_0_1,main,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Electric_hook_bd_main_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of Electric_hook_bd_main_0_1 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of Electric_hook_bd_main_0_1 : entity is "main,Vivado 2020.1";
end Electric_hook_bd_main_0_1;

architecture STRUCTURE of Electric_hook_bd_main_0_1 is
...
U0: entity work.Electric_hook_bd_main_0_1_main
     port map (
