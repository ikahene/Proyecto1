...
HD_PWD='C:/Users/byane/OneDrive/Escritorio/Proyecto1/catch_fish/catch_fish.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log catch_fish.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source catch_fish.tcl -notrace
