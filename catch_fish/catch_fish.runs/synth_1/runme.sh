...
HD_PWD='C:/Users/byane/OneDrive/Escritorio/Proyecto1/catch_fish/catch_fish.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log catch_fish.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source catch_fish.tcl
