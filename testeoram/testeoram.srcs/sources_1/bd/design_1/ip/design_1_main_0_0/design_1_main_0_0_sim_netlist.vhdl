...
entity design_1_main_0_0_clk_div is
  port (
    clk_div_catch_fish : out STD_LOGIC;
    clk : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_main_0_0_clk_div : entity is "clk_div";
end design_1_main_0_0_clk_div;

architecture STRUCTURE of design_1_main_0_0_clk_div is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_main_0_0_rgb_controller is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_main_0_0_rgb_controller : entity is "rgb_controller";
end design_1_main_0_0_rgb_controller;

architecture STRUCTURE of design_1_main_0_0_rgb_controller is
  signal clear : STD_LOGIC;
...
debounce0: entity work.design_1_main_0_0_debouncer
     port map (
      btn(0) => btn(0),
      btn_debounced(0) => btn_debounced(0),
      clk => clk
    );
debounce1: entity work.design_1_main_0_0_debouncer_0
     port map (
      btn(0) => btn(1),
...
rgb_control: entity work.design_1_main_0_0_rgb_controller
     port map (
      CO(0) => rgb2,
      clk => clk,
...
entity design_1_main_0_0 is
  ...
  attribute x_core_info of design_1_main_0_0 : entity is "main,Vivado 2020.1";
