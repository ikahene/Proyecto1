...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_decoder is
  ...
  signal \wr_en[2]_i_4_n_0\ : STD_LOGIC;
  signal \wr_en[2]_i_5_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \wr_en[2]_i_5\ : label is "soft_lutpair10";
begin
...
\wr_en[2]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\wr_en[2]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
\wr_en[2]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
...
DECODER_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_decoder
     port map (
      ...
      Read_int_i_2_0 => DECODER_INST_n_2,
      Read_int_i_3_0 => DECODER_INST_n_1,
      \out\ => bus_clk,
...
PROBE_IN_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_19_probe_in_one
     port map (
      ...
      Read_int_reg_1 => DECODER_INST_n_1,
      clk => clk,
      \out\ => bus_clk,
      probe_in0(3 downto 0) => probe_in0(3 downto 0),
      s_daddr_o(6 downto 4) => bus_addr(16 downto 14),
      s_daddr_o(3) => bus_addr(12),
