...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_debouncer is
  ...
  signal \pulsos[9]_i_1_n_0\ : STD_LOGIC;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_debouncer_1 is
  port (
    ...
    \state0__2\ : in STD_LOGIC;
    enable_pull_fish_sig_reg : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_debouncer_1 is
  ...
  attribute SOFT_HLUTNM of enable_catch_fish_sig_i_1 : label is "soft_lutpair0";
...
enable_catch_fish_sig_i_1: unisim.vcomponents.LUT5
    generic map(
      ...
      I0 => \state_reg[0]\,
      I1 => \state_reg[0]_0\,
      I2 => enable_pull_fish_sig_i_2_n_0,
...
enable_pull_fish_sig_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => enable_pull_fish_sig_i_2_n_0,
      I3 => \state0__2\,
      I4 => enable_pull_fish_sig_reg,
      I5 => game_end_catch_fish,
      O => \state_reg[1]_0\
    );
enable_pull_fish_sig_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000002"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_main is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of enable_pull_fish_sig_i_3 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \rgb[1]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \rgb[2]_INST_0\ : label is "soft_lutpair2";
...
debounce2: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_debouncer_1
     port map (
      ...
      enable_pull_fish_sig_reg => \^enable_pull_fish_sig_reg_0\,
      game_end_catch_fish => game_end_catch_fish,
      \state0__2\ => \state0__2\,
      \state_reg[0]\ => \state_reg_n_0_[1]\,
      \state_reg[0]_0\ => \state_reg_n_0_[0]\,
      \state_reg[1]\ => debounce2_n_1,
      \state_reg[1]_0\ => debounce2_n_2,
      \state_reg[1]_1\ => debounce2_n_3,
...
enable_pull_fish_sig_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4440"
    )
        port map (
