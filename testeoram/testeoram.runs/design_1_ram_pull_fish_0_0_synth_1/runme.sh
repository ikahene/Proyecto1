...
HD_PWD='C:/Users/byane/OneDrive/Escritorio/Proyecto1/testeoram/testeoram.runs/design_1_ram_pull_fish_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ram_pull_fish_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ram_pull_fish_0_0.tcl
