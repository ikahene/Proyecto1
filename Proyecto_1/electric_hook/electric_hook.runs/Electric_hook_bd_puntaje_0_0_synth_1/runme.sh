...
HD_PWD='C:/Users/Gabriela Rivera/OneDrive/Escritorio/Proyecto_1/electric_hook/electric_hook.runs/Electric_hook_bd_puntaje_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Electric_hook_bd_puntaje_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Electric_hook_bd_puntaje_0_0.tcl
