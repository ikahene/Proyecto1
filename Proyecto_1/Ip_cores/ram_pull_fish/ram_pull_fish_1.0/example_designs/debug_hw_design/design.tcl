...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of ram_pull_fish_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins ram_pull_fish_0/S00_pull_fish_AXI]
	connect_bd_net [get_bd_pins ram_pull_fish_0/s00_pull_fish_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ram_pull_fish_0/s00_pull_fish_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to ram_pull_fish_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/ram_pull_fish_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_ram_pull_fish_0_S00_pull_fish_AXI_* ]]
	puts $fp "set s00_pull_fish_axi_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:ram_pull_fish:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/ram_pull_fish_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "ram_pull_fish_v1_0_hw_${i}"
