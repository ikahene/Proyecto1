...
HD_PWD='C:/Users/Gabriela Rivera/OneDrive/Escritorio/SEP/pull_fish/pull_fish.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log temporal_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source temporal_main.tcl
