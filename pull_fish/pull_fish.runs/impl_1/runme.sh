...
HD_PWD='C:/Users/Gabriela Rivera/OneDrive/Escritorio/SEP/pull_fish/pull_fish.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log temporal_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source temporal_main.tcl -notrace
